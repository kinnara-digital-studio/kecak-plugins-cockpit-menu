...
//    }
    ...
    public final Optional<UserviewMenu> getUserviewMenu(String menuId) {
        if (userview == null) {
            LogUtil.info(getClassName(), "getUserMenuId: " + menuId);
            ...
            userview = userviewService.createUserview(json.toString(), null, false, contextPath, null, USERVIEW_KEY_EMPTY_VALUE, true);
        }
